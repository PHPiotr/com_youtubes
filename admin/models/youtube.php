...
class YoutubesModelYoutube extends JModelAdmin {
         ...
         * @since  1.6
         */
        protected $text_prefix = 'COM_YOUTUBES_YOUTUBE';
        ...
        /**
         * Batch client changes for a group of youtubes.
         *
        ...
        protected function loadFormData() {
                ...
                $this->preprocessData('com_youtubes.youtube', $data);
        ...
        public function save($data) {
                ...
                $oTable->hours = $data['hours'];
                $oTable->minutes = $data['minutes'];
                $oTable->seconds = $data['seconds'];
